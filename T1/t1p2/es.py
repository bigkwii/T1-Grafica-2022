...
class SimpleAlphaModelViewProjectionShaderProgram:
    ...
    def setupVAO(self, gpuShape):
        ...
        # 3d vertices + rgb color specification => 3*4 + 4*4 = 28 bytes
        position = glGetAttribLocation(self.shaderProgram, "position")
...
class SimpleColorModelViewProjectionShaderProgram:
    ...
    def __init__(self):
        ...
        fragment_shader = """
            ...
            void main()
            {
                outColor = colorScale * vec4(newColor, 1.0f);
            }
            """
...
class SimpleColorAlphaModelViewProjectionShaderProgram:
    ...
    def __init__(self):
        ...
        fragment_shader = """
            ...
            void main()
            {
                outColor = colorScale * vec4(newColor);
            }
            """
